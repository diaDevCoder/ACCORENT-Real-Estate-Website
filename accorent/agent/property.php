...
<head>
  ...
  <title>ACCORENT</title>
  <link rel="shortcut icon" href="/img/accorent.png" type="image/x-icon">
  ...
  <link rel="stylesheet" href="/css/colors/addtional.css">
  ...
  <div id="main">
    <nav class="navbar navbar-expand-lg bg-white" id="menu">
      ...
      <div class="container-fluid">
        <a class="navbar-brand mr-1" href="index.html"><img src="/img/logo.png" alt="accorent logo"></a>

        <div class="nav-link m-0 mr-3 p-0 tag">
          <a href="/index.html" class="tag text-bold tag-line text-dark m-0">ACCORENT</a>
          <a href="index.html" class="m-0 tag tag-line text-dark" style="font-size: 15px; text-transform: lowercase;">Makes life easier...</a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="menu-content">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
              <a class="nav-link btn-active" style="color: white;" href="index.html" role="button" aria-haspopup="true" aria-expanded="false">
                Home
              </a>

            </li>
            <li class="nav-item">
              <a class="nav-link" href="properties.html" role="button" aria-haspopup="true" aria-expanded="false">
                Properties
              </a>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="agents.html" role="button" aria-haspopup="true" aria-expanded="false">
                Agents
              </a>
            </li>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown user-account">
              ...
              <div class="dropdown-menu">
                ...
                <a href="/user/change_password.html" class="dropdown-item">Change Password</a>
                <a href="/user/account.html" class="dropdown-item">Account</a>
              </div>
            </li>
            <li class="nav-item"><a class="nav-button" href="signin.html"><span><i class="fa fa-user" aria-hidden="true"></i> Sign in or Sign up</span></a></li>
          </ul>
          <!--END OF NAV BAR ==============================================================-->
      ...
      <div class="row justify-content-md-center">
        <div class="col col-md-12 col-lg-12 col-xl-10">
          ...
          <div class="page-header bordered mb0">
            <div class="row">
              <div class="col-md-8"> <a href="properties.html" class="btn-return" title="Back"><i class="fa fa-angle-left"></i></a>
                ...
                <div id="sidebar" class="sidebar-right">
                  <div class="sidebar_inner">
                    ...
                    <div class="card shadow">
                      ...
                      <div class="media">
                        <div class="media-left"> <a href="agent.html"> <img class="media-object rounded-circle"
    ...
    <footer id="footer" class="bg-light footer-light">
      <div class="container container-1000">
        <div class="row">
          <div class="col-lg-3">
            <a class="navbar-brand mr-1" href="index.html"><img src="/img/accorent.png" width="70" alt="accorent logo"></a>
            <address class="mb-3">
              <strong>ACCORENT</strong><br>
        ...
        <div class="footer-credits d-lg-flex justify-content-lg-between align-items-center">
          <div>Powered by <strong>[Accorent]</strong></div>

          <div>© 2021 [Accorent]. All Rights Reserved</div>
        </div>
      </div>
    </footer>
  </div>
